...
class CreateGtdCertificateAppliesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gtd_certificate_applies', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('gtd_certificate_applies');
    }
}
